...
<div class="session--hub"><br />
    ...
    <?php
        ...
        <div id="editdices">
            ...
            <form method="POST" action="<?=base_url( 'userSpace/session/edit/dices' )?>">
                ...
                <input type="submit" class="btn btn-success" value="Save changes"><br /><br />
            </form>
        ...
        <div id="addplayersform">
            ...
            <form action="<?=base_url( 'userSpace/session/edit/newUser' )?>" method="POST">
                ...
                <input type="submit" class="btn btn-success" value="Invite new player" /><br /><br />
            </form>
        </div>
        <div id="changenames">
    ...
    <form class="roll--form padded" method="POST" action="<?=base_url( 'userSpace/session/roll' )?>">
        ...
        <label>
            <input type="checkbox" name="double"> Double roll</input>
        </label><br /><br />
...
<script type="text/javascript" src="<?=base_url( 'scripts/session.js' )?>"></script>
