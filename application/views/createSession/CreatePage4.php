<div class="session--hub">
    <h2>You've succesfully assigned the identificators!</h2>
    <br /><br />

    <label>Gamemaster's ID:</label><br />
    <input type="text" value="<?=$gm_id?>" disabled>
    <br /><br />

    <label>User's ID:</label><br />
    <input type="text" value="<?=$full_user_id?>" disabled>
    <br /><br />
